...
\renewcommand{\cftsubsubsecaftersnum}{.\hfill}
...
\setlength{\cftbeforechapskip}{0.0em}

% \CentChapters
\input{Chapters/onsoz}
\input{Chapters/tezEtik}
\renewcommand{\baselinestretch}{1}\normalsize % content aralıklarının 1pt olması
...
%%%% Sayfa numaralarının ALTTAN ve ortada olması için %%%%%%%%%%%%
%\pagestyle{fancy}
